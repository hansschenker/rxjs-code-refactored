...
import { MonoTypeOperatorFunction, OperatorFunction, TimestampProvider, ObservableInput, ObservedValueOf } from '../../../upstream-rxjs/src/internal/types';
...
export function publishReplay<T, R>(
  ...
  return (source: Observable<T>) => {
    ...
    return multicast(subject, selector!)(source);
  };
}
