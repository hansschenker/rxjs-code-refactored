import { OperatorFunction, ObservedValueOf, ObservableInput } from '../../../upstream-rxjs/src/internal/types';
...
export function mergeMapTo<T, R, O extends ObservableInput<unknown>>(
  ...
  const projectToInner = () => innerObservable;

  if (isFunction(resultSelector)) {
    return mergeMap(projectToInner, resultSelector, concurrent);
  }
  ...
  return mergeMap(projectToInner, concurrent);
}
