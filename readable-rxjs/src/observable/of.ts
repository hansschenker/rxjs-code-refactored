import { SchedulerLike, ValueFromArray } from '../../../upstream-rxjs/src/internal/types';
...
export function of<T>(...args: Array<T | SchedulerLike>): Observable<T> {
  // popScheduler removes a trailing scheduler argument (if present) from
  // `args`, leaving only the values to emit.
