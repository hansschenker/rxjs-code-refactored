import { combineLatest } from '../../../upstream-rxjs/src/internal/observable/combineLatest';
...
export function combineLatestAll<R>(project?: (...values: Array<any>) => R) {
  const combineLatestStrategy = combineLatest;

  return joinAllInternals(combineLatestStrategy, project);
}
