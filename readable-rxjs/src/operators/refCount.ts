...
export function refCount<T>(): MonoTypeOperatorFunction<T> {
  return operate((source, subscriber) => {
    ...
    const unsubscribeIfRefCountIsZero = () => {
      ...
      if (sharedConnection && (!localConnection || sharedConnection === localConnection)) {
    ...
    const refCounter = createOperatorSubscriber(subscriber, undefined, undefined, undefined, unsubscribeIfRefCountIsZero);
