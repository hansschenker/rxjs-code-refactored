...
import { ObservedValueOf, ObservableInput } from '../../../upstream-rxjs/src/internal/types';
...
export function defer<R extends ObservableInput<any>>(observableFactory: () => R): Observable<ObservedValueOf<R>> {
  return new Observable<ObservedValueOf<R>>((subscriber) => {
    // The factory runs once per subscription. If it throws, the Observable's
    // subscribe machinery routes the exception to `subscriber.error`.
