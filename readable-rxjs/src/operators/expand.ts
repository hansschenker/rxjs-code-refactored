import { OperatorFunction, ObservableInput, ObservedValueOf, SchedulerLike } from '../../../upstream-rxjs/src/internal/types';
...
export function expand<T, O extends ObservableInput<unknown>>(
  ...
  const expandValues = true;

  return operate((source, subscriber) => {
    mergeInternals(source, subscriber, project, concurrent, undefined, expandValues, scheduler);
  });
}
